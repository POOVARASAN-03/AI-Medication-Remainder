...
import { User, Mail, Lock, ArrowRight, Activity, Eye, EyeOff } from 'lucide-react';
...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Registration successful! Welcome to MedRemind AI.');
      navigate('/dashboard');
    } catch (err) {
    ...
    <div className="min-h-screen flex bg-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-primary-50 items-center justify-center overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-12 z-30 bg-gradient-to-t from-white/90 to-transparent">
          <h2 className="text-3xl font-heading font-bold text-primary-900 mb-2">Join MedRemind AI</h2>
          <p className="text-slate-600 text-lg">Start your journey to better health management today.</p>
        </div>
      </div>
